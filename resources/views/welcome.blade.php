    ...
    <body class="antialiased">
        <div class="flex flex-col gradient-bg bg-cover bg-center slant w-full h-screen">
            ...
            <div class="m-auto text-white w-100 text-center">
                ...
                <p class="text-xl font-italic">A simple integration of payment gateways (Paystack, Flutterwave) in Laravel</p>
                <a href="#" class="btn flash-button text-white animate animate-shake">Pay</a>
            </div>
        </div>
    </body>
</html>
